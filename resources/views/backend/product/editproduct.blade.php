                        ...
                        <div class="row" style="margin-bottom:40px">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <select name="category" class="form-control">
                                                {{ getCategory($categories,0,"",$prd->category_id) }}
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="number" name="price" class="form-control" value="{{ number_format($prd->price,0,"","") }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar" class="thumbnail" width="100%" height="100%" src="img/{{ $prd->img }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
